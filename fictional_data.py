...
QUESTIONS = [
    ...
    {
        "id": 2,
        "question_title": "Лучшие практики Go для микросервисов",
        "question_text": "Какие архитектурные паттерны и лучшие практики рекомендуются для построения микросервисов на Go?",
        "answers_count": 3,
    ...
    {
        "id": 3,
        "question_title": "Как настроить Django с PostgreSQL?",
        "question_text": "Подскажите, как правильно настроить соединение между Django и PostgreSQL на production сервере. Какие лучшие практики? Какие лучшие практики?",
        "answers_count": 3,
